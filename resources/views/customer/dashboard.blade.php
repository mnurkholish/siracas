<x-layouts.public title="Beranda - SIRACAS">
    ...
    <main>
        ...
        <section class="bg-secondary-soft px-6 py-10 lg:px-10">
            <div class="mx-auto flex max-w-7xl flex-col gap-4 rounded-lg border border-border bg-white px-5 py-5 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-[0_18px_34px_rgba(145,117,97,0.12)] sm:flex-row sm:items-center sm:justify-between sm:px-7"
                ...
                <div class="min-w-0">
                    ...
                    <h1 class="mt-2 text-2xl font-black text-text-body">Selamat datang kembali di SIRACAS</h1>
            ...
            <div class="mx-auto mt-5 grid max-w-7xl gap-4 md:grid-cols-3" x-data="{ active: 'produk' }">
                <a href="{{ route('products.index') }}" @mouseenter="active = 'produk'"
                    ...
                    <div class="flex items-center justify-between gap-4">
                        <div>
                            <p class="text-xs font-bold uppercase tracking-[0.28em] text-muted-light">Produk</p>
                            <h2 class="mt-2 text-lg font-black text-text-body">Lihat Katalog</h2>
                        </div>
                        <span
                ...
                <a href="{{ route('cart.index') }}" @mouseenter="active = 'keranjang'"
                    ...
                    <div class="flex items-center justify-between gap-4">
                        <div>
                            <p class="text-xs font-bold uppercase tracking-[0.28em] text-muted-light">Keranjang</p>
                            <h2 class="mt-2 text-lg font-black text-text-body">Pesanan Saya</h2>
                        </div>
                        <span
                            class="flex h-11 w-11 items-center justify-center rounded-full bg-accent-soft text-primary-dark transition group-hover:bg-primary group-hover:text-white">
                ...
                <a href="{{ route('profile') }}" @mouseenter="active = 'akun'"
                    ...
                    <div class="flex items-center justify-between gap-4">
                        <div>
                            <p class="text-xs font-bold uppercase tracking-[0.28em] text-muted-light">Akun</p>
                            <h2 class="mt-2 text-lg font-black text-text-body">Profil Customer</h2>
                        </div>
                        <span
                            class="flex h-11 w-11 items-center justify-center rounded-full bg-accent-soft text-primary-dark transition group-hover:bg-primary group-hover:text-white">
        ...
        <x-home.products-section :products="$products" :all-link="route('products.index')" />
