<footer class="mt-auto bg-secondary px-6 py-14 text-sm text-muted lg:px-10">
    ...
    <div class="mx-auto mt-12 flex max-w-7xl flex-col gap-4 border-t border-border-strong pt-6 sm:flex-row sm:items-center sm:justify-between">
        <p class="text-xs text-muted">© 2026 Siracas. All rights reserved.</p>
        <div class="flex items-center gap-3 text-xs text-muted">
            <span>Connect with us</span>
            <a href="#" class="rounded-full border border-border-strong p-2 transition hover:bg-white/60" aria-label="Instagram">
                <x-home.icon name="instagram" alt="Instagram" class="h-4 w-4" />
            </a>
            <a href="#" class="rounded-full border border-border-strong p-2 transition hover:bg-white/60" aria-label="TikTok">
                <x-home.icon name="tiktok" alt="TikTok" class="h-4 w-4" />
            </a>
            <a href="#" class="rounded-full border border-border-strong p-2 transition hover:bg-white/60" aria-label="LinkedIn">
                <x-home.icon name="linkedin" alt="LinkedIn" class="h-4 w-4" />
            </a>
        </div>
    </div>
</footer>
